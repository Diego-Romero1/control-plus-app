...
export function drawBackground(options) {
...
export function drawTicks(options) {
...
export function drawTextMarkers(options) {
...
export function drawSpeedometerColourArc(options) {
...
export function drawNeedle(options) {
...
export function buildOptionsAsJSON(canvas, iSpeed) {
...
export function clearCanvas(options) {
    options.ctx.clearRect(0, 0, 800, 400);
    applyDefaultContextSettings(options);
}
